...
<div class="container theme-showcase" style="max-width: 40%">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h1 align="center">Добавить деталь</h1>
        </div>
        <div class="panel-body">
            <c:url var="addAction" value="/parts/add"></c:url>
            <form:form action="${addAction}" commandName="add">
                <table class="table table-striped">
                    ...
                    <tr>
                        <td colspan="2" class="well well-sm text-center">
                            <input class="btn btn-primary btn-lg " type="submit" value="<spring:message text="Добавить"/>"/>
                        </td>
                    </tr>
                </table>
            </form:form>
